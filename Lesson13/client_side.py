...
class Client(Thread, QObject):
    ...
    def __init__(self, cl_db, rcv_func=None, snd_func=None, sock=None, name=None):
    ...
    while True:
        try:
            ...
            if 'action' in msg and msg['action'] == 'message' and \
                ...
                db_cl.store_message_in_db(msg['author'],
                                          True,
                                          msg['post_text'])
                cl.new_message.emit(msg['author'])
...
def main_start():
    ...
    client1 = Client(cl_db1, rcv_func=None, snd_func=None, sock=None, name=username)
    ...
    main_window = ClientMainWindow(cl_db1, client1, username)
